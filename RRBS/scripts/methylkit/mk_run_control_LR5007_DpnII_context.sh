...
for i in $(seq 1 12); do
	...
	mkdir control_LR5007_DpnII_$1
    	cd control_LR5007_DpnII_$1
	...
	echo "Rscript --no-save --no-restore --no-init-file --no-site-file -e \"library(knitr);chromosome <- '$chr';context<-'$1';knit2html('MK_control_vs_LR5007_DpnII.Rmd')\"" >> "MK_control_LR5007_DpnII_"$chr".sh"
...
qsub -N gatherInfo_context.sh -l h_vmem=5g -hold_jid $joblist gatherInfo_context.sh control_LR5007_DpnII_$1 $1
